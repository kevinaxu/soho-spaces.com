...
const data = {
    ...
    "url": "https://soho-spaces.com/portfolio/dark-academia",
    "content": {
    ...
    "images": [
        ...
        "/assets/dark-academia/chair2.jpeg",
        "/assets/dark-academia/sofa_close_up.jpeg",
        "/assets/dark-academia/IMG_9150.jpeg",
        "/assets/dark-academia/IMG_0008.jpeg",
        "/assets/dark-academia/IMG_0014.jpeg",
        "/assets/dark-academia/IMG_0020.jpeg",
        "/assets/dark-academia/IMG_0010.jpeg",
        "/assets/dark-academia/IMG_3487.jpeg",
        "/assets/dark-academia/candles.jpeg",
        "/assets/dark-academia/IMG_0021.jpeg",
        "/assets/dark-academia/candlesticks.jpeg",
        "/assets/dark-academia/record1.jpeg"
    ],
    "navBar": {
    ...
    "previewCard": {
        "image": "https://soho-spaces.com/assets/dark-academia/IMG_0020.jpeg",
        "height": "800",
        "width": "600"
    },
    "config": {
 ...
 * @param {Array} data.images - An array of image URLs.
...
/**
 * Load partial Mustache templates from the specified directory.
 *
 ...
 */
function loadPartialTemplates(partials) {
    const partialDirectory = path.join('_templates', 'partials');
    const partialTemplates = {};

    partials.forEach(partial => {
        const partialPath = path.join(partialDirectory, `${partial}.mustache`);
        try {
